...
Shader "Tobyfredson/Torch Flame (HDRP)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float screenDepth155 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float2 texCoord124 = packedInput.ase_texcoord2.xy * float2( 0.6,0.6 ) + float2( 0,0 );
				...
				float2 texCoord125 = packedInput.ase_texcoord2.xy * float2( 0.5,0.5 ) + float2( 0.35,0.4 );
				...
				float2 texCoord112 = packedInput.ase_texcoord2.xy * float2( 0.6,0.6 ) + float2( 0,0 );
				float2 panner110 = ( 0.3 * _Time.y * float2( 0.5,-2 ) + ( temp_output_54_0 + texCoord112 ));
				float4 tex2DNode105 = tex2D( _FastFlame, panner110 );
				float2 texCoord116 = packedInput.ase_texcoord2.xy * float2( 0.5,0.5 ) + float2( 0.35,0.4 );
				...
				float2 texCoord7 = packedInput.ase_texcoord2.xy * float2( 3,2 ) + float2( 0,0 );
				...
				float2 uv_AlphaMask90 = packedInput.ase_texcoord2.xy;
				...
				float2 coords140 = packedInput.ase_texcoord2.xy * 1.0;
				float2 id140 = 0;
				float2 uv140 = 0;
				...
				float3 hdEmission167 = ASEGetEmissionHDRColor(( distanceDepth155 * ( saturate( lerpBlendMode139 )) ).rgb,_EMPower,_EMWeight,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Color = hdEmission167;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float2 appendResult47 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 temp_output_54_0 = ( appendResult47 * 0.1 );
				float2 texCoord124 = packedInput.ase_texcoord4.xy * float2( 0.6,0.6 ) + float2( 0,0 );
				float2 panner127 = ( 0.3 * _Time.y * float2( 0.5,-2 ) + ( temp_output_54_0 + texCoord124 ));
				float4 tex2DNode128 = tex2D( _BlazeParticles, panner127 );
				float2 texCoord125 = packedInput.ase_texcoord4.xy * float2( 0.5,0.5 ) + float2( 0.35,0.4 );
				float2 panner126 = ( 0.8 * _Time.y * float2( 0,-1 ) + ( temp_output_54_0 + texCoord125 ));
				float4 tex2DNode129 = tex2D( _BlazeParticles, panner126 );
				Gradient gradient109 = NewGradient( 0, 4, 3, float4( 0.1415094, 0.02096804, 0, 0 ), float4( 1, 0.5159165, 0.3254902, 0.3353018 ), float4( 1, 0.9982066, 0.5803922, 0.5882353 ), float4( 1, 1, 1, 1 ), 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 0.282353 ), float2( 1, 1 ), 0, 0, 0, 0, 0 );
				float2 texCoord112 = packedInput.ase_texcoord4.xy * float2( 0.6,0.6 ) + float2( 0,0 );
				float2 panner110 = ( 0.3 * _Time.y * float2( 0.5,-2 ) + ( temp_output_54_0 + texCoord112 ));
				float4 tex2DNode105 = tex2D( _FastFlame, panner110 );
				float2 texCoord116 = packedInput.ase_texcoord4.xy * float2( 0.5,0.5 ) + float2( 0.35,0.4 );
				float2 panner114 = ( 0.8 * _Time.y * float2( 0,-1 ) + ( temp_output_54_0 + texCoord116 ));
				float4 tex2DNode106 = tex2D( _FastFlame, panner114 );
				Gradient gradient1 = NewGradient( 0, 4, 3, float4( 0.1415094, 0.02096804, 0, 0 ), float4( 1, 0.5159165, 0.3254902, 0.3353018 ), float4( 1, 0.9982066, 0.5803922, 0.5882353 ), float4( 1, 1, 1, 1 ), 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 0.282353 ), float2( 1, 1 ), 0, 0, 0, 0, 0 );
				float2 appendResult5 = (float2(0.0 , -1.5));
				float2 texCoord7 = packedInput.ase_texcoord4.xy * float2( 3,2 ) + float2( 0,0 );
				float2 panner13 = ( 1.0 * _Time.y * appendResult5 + ( temp_output_54_0 + ( 1.22 * texCoord7 ) ));
				float simplePerlin2D20 = snoise( panner13 );
				simplePerlin2D20 = simplePerlin2D20*0.5 + 0.5;
				float2 appendResult12 = (float2(0.0 , -1.0));
				...
				float simplePerlin2D21 = snoise( panner14 );
				simplePerlin2D21 = simplePerlin2D21*0.5 + 0.5;
				float2 texCoord61 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult56 = (float2(-_Flamespeed , -_Flamespeed));
				float2 texCoord49 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner57 = ( 1.0 * _Time.y * appendResult56 + ( temp_output_54_0 + ( texCoord49 * _NoiseScale ) ));
				float4 tex2DNode73 = tex2D( _BaseFlame, ( texCoord61 + ( texCoord61.y * ( (tex2D( _NoiseTexture, panner57 )).g - 0.2 ) * texCoord61.y ) ) );
				float4 blendOpSrc92 = saturate( ( SampleGradient( gradient109, ( tex2DNode105 + tex2DNode106 ).r ) + SampleGradient( gradient1, ( simplePerlin2D20 * simplePerlin2D21 ) ) ) );
				float4 blendOpDest92 = ( _Brightnessmultiply * ( ( _Color0 * tex2DNode73.r ) + ( _Color1 * tex2DNode73.g ) + ( tex2DNode73.b * _Color2 ) + ( tex2DNode73.a * _Color3 ) ) );
				float2 uv_AlphaMask90 = packedInput.ase_texcoord4.xy;
				float4 tex2DNode90 = tex2D( _AlphaMask, uv_AlphaMask90 );
				float4 lerpBlendMode92 = lerp(blendOpDest92,(( blendOpDest92 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest92 ) * ( 1.0 - blendOpSrc92 ) ) : ( 2.0 * blendOpDest92 * blendOpSrc92 ) ),( 1.0 - tex2DNode90 ).r);
				float4 blendOpSrc139 = SampleGradient( gradient131, ( tex2DNode128 + tex2DNode129 ).r );
				float4 blendOpDest139 = ( saturate( lerpBlendMode92 ));
				float time140 = 0.0;
				float2 voronoiSmoothId140 = 0;
				float2 coords140 = packedInput.ase_texcoord4.xy * 1.0;
				float2 id140 = 0;
				float2 uv140 = 0;
				float voroi140 = voronoi140( coords140, time140, id140, uv140, 0, voronoiSmoothId140 );
				float4 lerpBlendMode139 = lerp(blendOpDest139,( blendOpSrc139 + blendOpDest139 ),( tex2DNode90 + ( 6.2 * ( -0.88 + ( 1.0 - voroi140 ) ) ) ).r);
...
Node;AmplifyShaderEditor.ColorNode;69;-680.3892,1373.745;Inherit;False;Property;_Color1;Color 1;4;0;Create;True;0;0;0;False;0;False;1,0.1058824,0,1;1,0.1058801,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;118;-366.3185,-155.858;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;68;-673.4178,1100.806;Inherit;False;Property;_Color0;Color 0;3;0;Create;True;0;0;0;False;0;False;1,0.4313726,0,1;1,0.4313713,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.HDEmissionNode;167;882.1263,-224.6871;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;157;737.2877,-322.7921;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;156;202.9457,-345.2095;Inherit;False;Property;_DepthFadeAmount;Depth Fade Amount;12;0;Create;True;0;0;0;False;0;False;0;0.46;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;155;429.8631,-364.257;Inherit;False;True;True;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BillboardNode;166;964.3812,40.77294;Inherit;False;Spherical;True;True;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;80;-227.5399,1239.406;Inherit;False;Property;_Brightnessmultiply;Brightness multiply;1;0;Create;True;0;0;0;False;0;False;0;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;175;-295.851,-322.877;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;72;-707.8022,1667.709;Inherit;False;Property;_Color2;Color 2;5;0;Create;True;0;0;0;False;0;False;0,1,0.145098,1;0,1,0.1433044,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;168;405.7042,-237.7875;Inherit;False;Property;_EMPower;EM Power;13;0;Create;True;0;0;0;False;0;False;-2;0.374;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BlendOpsNode;139;464.9956,-47.92576;Inherit;True;LinearDodge;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.GradientSampleNode;108;-772.8218,-503.9067;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;70;-712.2827,1937.254;Inherit;False;Property;_Color3;Color 3;6;0;Create;True;0;0;0;False;0;False;0.7450981,0,0.4313726,1;0.745283,0,0.4311403,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;169;402.3161,-147.3879;Inherit;False;Property;_EMWeight;EM Weight;14;0;Create;True;0;0;0;False;0;False;0;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;176;-398.5936,-1324.611;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;159;6;166;0
ASEEND*/
//CHKSM=5D2D8D59E7D9057D9FD78308FE54D7160B4A04D3