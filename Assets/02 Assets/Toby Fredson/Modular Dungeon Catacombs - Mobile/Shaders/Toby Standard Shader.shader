...
Shader "Tobyfredson/Toby Standard Shader"
{
	Properties
	{
		...
		[ASEEnd]_Ao("Ambient Occlusion", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord24 = packedInput.ase_texcoord5.xy * _Tiling + _Offset;
				
				float3 unpack17 = UnpackNormalScale( tex2D( _NormalMap, texCoord24 ), _NormalIntensity );
				unpack17.z = lerp( 1, unpack17.z, saturate(_NormalIntensity) );
				
				float4 tex2DNode9 = tex2D( _MetallicAoGloss, texCoord24 );
				
				surfaceDescription.BaseColor = tex2D( _AlbedoMap, texCoord24 ).rgb;
				surfaceDescription.Normal = unpack17;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( tex2DNode9.r * _Metallic );
				...
				surfaceDescription.Smoothness = ( tex2DNode9.a * _Smoothness );
				surfaceDescription.Occlusion = pow( abs( tex2DNode9.g ) , _Ao );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord24 = packedInput.ase_texcoord2.xy * _Tiling + _Offset;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord24 = packedInput.ase_texcoord3.xy * _Tiling + _Offset;
				float3 unpack17 = UnpackNormalScale( tex2D( _NormalMap, texCoord24 ), _NormalIntensity );
				unpack17.z = lerp( 1, unpack17.z, saturate(_NormalIntensity) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord24 = packedInput.ase_texcoord7.xy * _Tiling + _Offset;
...
WireConnection;25;4;15;0
WireConnection;25;7;16;0
WireConnection;25;8;18;0
ASEEND*/
//CHKSM=AFD2B51A3A0D41133A01539A471FFAEF05FE96C0