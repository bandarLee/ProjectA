...
Shader "Tobyfredson/Tree Billboard (HDRP)"
{
	Properties
	{
		...
		[HDR][HideInInspector]_DiffusionProfileAsset("Diffusion Profile", Vector) = ( 0, 0, 0, 0 )
		[HideInInspector]_DiffusionProfileHash("Diffusion Profile", Float) = 0
		_Gloss("Gloss", Range( 0 , 1)) = 1
		_Cutout("Cutout", Range( 0 , 1)) = 0.4
		[ASEEnd]_GrassColorvariatoionPower("Grass Color variatoion Power", Range( 0 , 5)) = 0.6
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 localWorldVar12 = float4( ase_worldPos , 0.0 );
				(localWorldVar12).xyz = GetCameraRelativePositionWS((localWorldVar12).xyz);
				float4 transform12 = mul(GetWorldToObjectMatrix(),localWorldVar12);
				float temp_output_22_0 = ( ( inputMesh.positionOS.y * cos( ( ( ( transform12.x + transform12.z ) * _WorldFreq ) + ( _TimeParameters.x ) ) ) ) * _Bentamount );
						...
						)
			{
				...
				float3 objToWorld123 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float dotResult4_g17 = dot( objToWorld123.xy , float2( 12.9898,78.233 ) );
				...
				#endif
				float2 uv_LeavesMask121 = packedInput.ase_texcoord5.xy;
				...
				float4 lerpResult122 = lerp( tex2DNode4 , ( _AlbedoColor * lerpResult120 ) , tex2DNode121);
				...
				float4 appendResult70 = (float4(tex2DNode2.r , tex2DNode2.g , ( tex2DNode2.b * isFrontFace ) , 0.0));
				...
				surfaceDescription.BaseColor = lerpResult122.rgb;
				surfaceDescription.Normal = appendResult70.xyz;
				...
				surfaceDescription.Smoothness = ( _Gloss * tex2DNode3.a );
				surfaceDescription.Occlusion = lerpResult41.r;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = tex2DNode3.b;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 staticSwitch103 = tex2DNode4;
				#endif
				float2 uv_LeavesMask121 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode121 = tex2D( _LeavesMask, uv_LeavesMask121 );
				float4 lerpResult120 = lerp( tex2DNode4 , ( staticSwitch103 * _AlbedoLightness ) , tex2DNode121);
				float4 lerpResult122 = lerp( tex2DNode4 , ( _AlbedoColor * lerpResult120 ) , tex2DNode121);
		...
		Pass
		{
						...
						)
			{
				...
				float4 staticSwitch103 = tex2DNode4;
				#endif
				float2 uv_LeavesMask121 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode121 = tex2D( _LeavesMask, uv_LeavesMask121 );
				float4 lerpResult120 = lerp( tex2DNode4 , ( staticSwitch103 * _AlbedoLightness ) , tex2DNode121);
				float4 lerpResult122 = lerp( tex2DNode4 , ( _AlbedoColor * lerpResult120 ) , tex2DNode121);
...
/*ASEBEGIN
Version=19106
Node;AmplifyShaderEditor.CommentaryNode;88;-2577.491,-452.1584;Inherit;False;1668.825;1070.927;;15;39;114;113;111;109;103;33;2;3;4;118;119;120;121;122;Base Inputs;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;127;-510.4694,463.1584;Inherit;False;232;209;AO;1;41;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;125;-869.8563,-62.99063;Inherit;False;502.2921;275.1473;Normal;3;68;69;70;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;91;-3918.181,-404.7016;Inherit;False;1055.403;552.1744;Comment;8;101;100;98;96;95;94;117;123;Grass Color Variation;0.7504205,1,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;126;-630.8262,220.1096;Inherit;False;505.2545;235.5896;Smoothness;2;74;75;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;10;-3217.311,752.1107;Inherit;False;3214.55;784.7615;Comment;22;29;24;25;26;27;30;31;28;23;22;21;20;18;19;17;15;16;13;14;12;11;140;Trunk Bend;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;75;-580.8262,339.6991;Inherit;False;Property;_Gloss;Gloss;12;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BillboardNode;140;-343.5986,954.2229;Inherit;False;Cylindrical;False;True;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;143;-115.8396,992.4961;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;74;-287.5716,270.1096;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;141;105.9284,296.7752;Inherit;False;Property;_Cutout;Cutout;13;0;Create;True;0;0;0;False;0;False;0.4;0.024;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DiffusionProfileNode;142;100.6579,389.8427;Float;False;Property;_DiffusionProfile;Diffusion Profile;11;1;[HDR];Create;True;0;0;0;False;0;False;0;0;True;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;70;-528.5643,29.15669;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.LerpOp;41;-460.4695,513.1582;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FaceVariableNode;68;-819.8563,71.2722;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TransformPositionNode;123;-3902.4,-358.5679;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-3452.539,-74.47817;Inherit;False;Property;_GrassColorvariatoionPower;Grass Color variatoion Power;14;0;Create;True;0;0;0;False;0;False;0.6;5;0;5;0;1;FLOAT;0
...
WireConnection;155;1;70;0
WireConnection;155;7;74;0
WireConnection;155;8;41;0
WireConnection;155;9;4;4
WireConnection;155;10;141;0
WireConnection;155;16;3;3
WireConnection;155;62;142;0
WireConnection;155;11;143;0
ASEEND*/
//CHKSM=39CBBE496A04F4041A718980BEB320A500E8C079