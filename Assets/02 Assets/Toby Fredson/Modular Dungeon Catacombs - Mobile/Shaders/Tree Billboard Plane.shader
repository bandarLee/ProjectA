...
Shader "Tobyfredson/Tree Billboard Plane (HDRP)"
{
	Properties
	{
		...
		[ASEEnd]_Cutout("Cutout", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 objToWorld152 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float dotResult4_g17 = dot( objToWorld152.xy , float2( 12.9898,78.233 ) );
				...
				#endif
				float2 uv_LeafMask118 = packedInput.ase_texcoord5.xy;
				...
				float4 lerpResult123 = lerp( tex2DNode4 , ( _AlbedoColor * lerpResult120 ) , tex2DNode118);
				...
				float3 appendResult136 = (float3(tex2DNode2.r , ( tex2DNode2.g * isFrontFace ) , tex2DNode2.b));
				float3 appendResult82 = (float3(tex2DNode2.r , tex2DNode2.g , ( tex2DNode2.b * isFrontFace )));
				...
				float4 temp_cast_4 = (tex2DNode3.g).xxxx;
				float4 lerpResult41 = lerp( color39 , temp_cast_4 , _AoIntensity);
				
				surfaceDescription.BaseColor = lerpResult123.rgb;
				surfaceDescription.Normal = staticSwitch83;
				...
				#ifdef _MATERIAL_FEATURE_TRANSMISSION
				surfaceDescription.TransmissionMask = tex2DNode3.b;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 staticSwitch103 = tex2DNode4;
				#endif
				float2 uv_LeafMask118 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode118 = tex2D( _LeafMask, uv_LeafMask118 );
				float4 lerpResult120 = lerp( tex2DNode4 , ( staticSwitch103 * _AlbedoLightness ) , tex2DNode118);
				float4 lerpResult123 = lerp( tex2DNode4 , ( _AlbedoColor * lerpResult120 ) , tex2DNode118);
		...
		Pass
		{
						...
						)
			{
				...
				float4 staticSwitch103 = tex2DNode4;
				#endif
				float2 uv_LeafMask118 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode118 = tex2D( _LeafMask, uv_LeafMask118 );
				float4 lerpResult120 = lerp( tex2DNode4 , ( staticSwitch103 * _AlbedoLightness ) , tex2DNode118);
				float4 lerpResult123 = lerp( tex2DNode4 , ( _AlbedoColor * lerpResult120 ) , tex2DNode118);
...
Node;AmplifyShaderEditor.CommentaryNode;91;-4539.335,-617.3804;Inherit;False;1055.403;552.1744;Comment;8;101;100;98;96;95;94;117;152;Grass Color Variation;0.7504205,1,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1355.622,317.1799;Inherit;False;Property;_AoIntensity;Ao Intensity;10;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-793.0833,720.0845;Inherit;False;Property;_Winddirection;Wind direction;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;83;-580.2516,-103.3049;Inherit;False;Property;_NormalBackFaceFix;Normal BackFace Fix;12;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RotateAboutAxisNode;30;-462.3727,873.72;Inherit;False;True;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.DiffusionProfileNode;150;6.867121,379.5538;Float;False;Property;_DiffusionProfile;Diffusion Profile;13;0;Create;True;0;0;0;False;0;False;0;0;True;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-11.21519,285.3571;Inherit;False;Property;_Cutout;Cutout;15;0;Create;True;0;0;0;False;0;False;0;0.024;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;4;-3185.396,-159.0175;Inherit;True;Property;_AlbedoMap;Albedo Map;1;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;e9c4642eaa083a54ab91406d8449e6ac;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;121;-2883.318,55.43172;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TransformPositionNode;152;-4491.175,-567.4558;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-2752.388,1070.874;Inherit;False;Property;_WorldFreq;World Freq;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-4073.694,-287.157;Inherit;False;Property;_GrassColorvariatoionPower;Grass Color variatoion Power;14;0;Create;True;0;0;0;False;0;False;0.6;0.6;0;5;0;1;FLOAT;0
...
WireConnection;163;1;83;0
WireConnection;163;7;74;0
WireConnection;163;8;41;0
WireConnection;163;9;4;4
WireConnection;163;10;149;0
WireConnection;163;61;3;3
WireConnection;163;62;150;0
WireConnection;163;11;30;0
WireConnection;41;0;39;0
WireConnection;41;1;3;2
WireConnection;41;2;33;0
ASEEND*/
//CHKSM=173D3F90F733F274A98BE6D0B8246A579337FBB4